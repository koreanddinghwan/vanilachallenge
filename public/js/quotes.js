...
//어레이의 형태로 키:밸류값을 가진 오브젝트들을 quotes에 저장한다.


const quote = document.querySelector("#quote span:first-child") //span의 첫번째
const author = document.querySelector("#quote span:last-child") //span의 두번째


const todaysQuote = quotes[Math.floor(Math.random()*(quotes.length))] 
//난수는 0부터시작 1미만의 값을 리턴한다. 따라서 quotes.length를 곱하면 많아봤자 0.999*quotes.length인데 floor함수를 적용하기 때문에
//quotes배열 내의 인덱스가 할당된다. 
